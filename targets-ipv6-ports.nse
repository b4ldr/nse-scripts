...
---
-- @usage
-- nmap -6 -p 80 --script targets-ipv6-ports --script-args newtargets,targets-ipv6-subnet={2001:db8:c0ca::/64}
--
-- @output
...
local Prescanning = function ()
  ...
  local User_Segs = stdnse.get_script_args "targets-ipv6-ports.nsegments"
  local User_Right = stdnse.get_script_args "targets-ipv6-wordlist.fillright"
  local ports = (stdnse.get_script_args("targets-ipv6-ports.ports")
    or {21,22,23,25,80,135,139,443,445,666,999,3306,3389,4567})

  -- Second, we read our vital table
  local TablaPalabras, sError = LeerArchivo(ports)
